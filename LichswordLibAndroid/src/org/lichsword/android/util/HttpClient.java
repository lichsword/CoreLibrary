...
public class HttpClient extends DefaultHttpClient {
     ...
     */
    public static boolean downloadFile(final String url, final File saveToFile, IFileProcess callback) {
     ...
     * @return true if success, false otherise.
     */
    public static Bitmap downloadImage(final String url, final File saveFile) {
        Bitmap bitmap = null;
        if (TextUtils.isEmpty(url)) {
            return null;
        }
        ...
        try {
            ...
            HttpClient httpClient = HttpClient.newInstance();
     ...
     * @param pairs
     */
    public static HttpResponse postContent(final String url, List<NameValuePair> pairs) {
    ...
    public static String postContentWithResponseContent(final String url, List<NameValuePair> pairs) {
